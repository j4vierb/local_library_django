...
# important Metadata for the model
# (https://docs.djangoproject.com/en/5.0/ref/models/options/)
# - db_table = "table name"
# - db_table_comment = "Description of the table"
# > Contraints
# (https://docs.djangoproject.com/en/5.0/ref/models/constraints/)
# - CheckConstraint(check=Q(param__cond=18), name='check name')
...
class Genre(models.Model):
  ...
  id = models.AutoField(
    primary_key=True,
    unique=True,
    help_text="Unique ID for a Genre"
  )
...
class Language(models.Model):
  ...
  id = models.AutoField(
    primary_key=True,
    unique=True,
    help_text="Unique ID for a Language"
  )
...
class Book(models.Model):
  ...
  id = models.AutoField(
    primary_key=True,
    unique=True,
    help_text="Unique ID for a Book"
  )
...
class Author(models.Model):
  ...
  id = models.AutoField(
    primary_key=True,
    unique=True,
    help_text="Unique ID for an Author"
  )
